...
- **Tiny / mechanical** (a single edit, <10 lines, rename, typo fix, config tweak, single-file mutation): orchestrator builds directly. No review needed — self-review on trivial code is diminishing returns regardless of model.
